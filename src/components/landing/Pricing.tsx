          ...
          {plans?.map((plan, index) => {
            ...
            return (
              <div
                ...
                className={`pricing-card relative p-6 rounded-2xl border transition-all flex flex-col cursor-pointer ${isHighlighted
              ...
              >
                {/* Icon */}
                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 ${isHighlighted
                  ? "bg-white/20"
                  : "bg-primary/10"
                  }`}>
                  <Diamond className={`h-7 w-7 ${isHighlighted
                    ? "text-white"
                    : "text-primary"
                    }`} />
                </div>
                ...
                <ul className="space-y-3 mb-6 flex-grow">
                  {plan.highlight?.map((item: string, i: number) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
                      <Check className={`h-4 w-4 mt-0.5 flex-shrink-0 ${isHighlighted ? "text-white" : "text-primary"
                        }`} />
                ...
                <div className="mb-6 mt-auto">
                  ...
                  <span className={isHighlighted ? "text-white/70" : "text-muted-foreground"}>
                ...
                <Button
                  ...
                  className={`w-full group ${isHighlighted
